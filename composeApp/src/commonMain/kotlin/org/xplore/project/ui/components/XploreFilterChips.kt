...
/**
 * Horizontally scrollable row of filter chips with a "Genera percorso"
 * accent chip at the end. The settings gear has been removed from here
 * and moved to the Profile screen.
 */
@Composable
